...
function securityApi(
  ...
  return {
    ...
    listMcpConnections: vi.fn().mockResolvedValue({ ok: false, problem: unavailable }),
    listMcpBranches: vi.fn().mockResolvedValue({ ok: false, problem: unavailable }),
    listMcpAudit: vi.fn().mockResolvedValue({ ok: false, problem: unavailable }),
