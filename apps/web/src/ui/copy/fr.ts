...
export const FR_COPY = {
  ...
  security: {
    ...
    devices: {
      ...
      rename: "Renommer",
      reauthorize: "Exiger une reconnexion",
      revoke: "Révoquer",
    ...
    recovery: {
      ...
      confirmed: "Confirmé",
      notYet: "pas encore",
      generate: "Générer un nouveau kit",
      replacementSafety:
  ...
  editor: {
    ...
    richBlocks: {
      ...
      table: {
        ...
        rowMenu: "Actions de la ligne",
        columnMenu: "Actions de la colonne",
        ...
        moveColumnLeft: "Déplacer la colonne à gauche",
        moveColumnRight: "Déplacer la colonne à droite",
        dragToMove: "glisser pour déplacer",
        clearRow: "Vider la ligne",
        clearColumn: "Vider la colonne",
