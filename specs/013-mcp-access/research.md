...
- [MCP Streamable HTTP2026-07-28](https://modelcontextprotocol.io/specification/2026-07-28/basic/transports/streamable-http): current stateless protocol, request metadata and header validation; use SDK rather than hand-built JSON-RPC.
...
- [SDK legacy routing](https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/legacy-routing/README.md): supported compatibility path for2025-era clients.
