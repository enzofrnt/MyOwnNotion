...
- [ ] T113 Exécuter les tests ciblés, la matrice WebKit de convergence structurée puis `pnpm checks:local`, et consigner les preuves immuables dans `validation.md` per FR-035 (missing)
