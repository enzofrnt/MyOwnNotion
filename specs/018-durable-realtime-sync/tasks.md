...
- [ ] T101 Exécuter `pnpm checks:local` selon `docs/development.md` et enregistrer le commit exact et le résultat dans `specs/018-durable-realtime-sync/validation.md`
