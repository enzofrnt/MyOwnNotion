...
- [ ] T002 Ajouter les emplacements chiffrés et leur validation/fusion dans `packages/domain/src/databases/` et les contrats.
- [ ] T003 Migrer le registre de sources/révisions et détacher le cycle de vie des hôtes dans `packages/database/migrations/0016_linked_databases.sql` et les repositories.

## Phase 2 — US1 et US2 : sources et configurations

- [ ] T004 [US1] Adapter les mutations et lectures API à la source indépendante et à la création intégrée, avec snapshots protégés.
- [ ] T005 [US1] Adapter projection et mutations locales chiffrées pour les sources et emplacements réutilisés hors ligne.
...
- [ ] T008 [US3] Couvrir export/restauration, protection des révisions de source, suppression et purge de tous les hôtes, et reprise hors ligne.
