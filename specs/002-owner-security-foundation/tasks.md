...
- `T073–T089 → T090–T105`: recovery/rotation contracts and implementations precede migration, Compose, CI, GHCR, and rollback evidence.
- `T024–T105 → T106–T113`: all six story checkpoints precede cross-feature regression, full gates, analysis, convergence, and final ledger review.
...
- T106 and T107 can run in parallel after all story checkpoints; T108–T113 are sequential evidence and governance gates.
...
| --- | --- | --- |
| FR-001 | `spec.md` §Requirements; `validation.md` FR-001 | T007, T010, T018, T019, T026, T029, T031, T032, T036, T082, T104, T112, T113 |
| FR-002 | `spec.md` §Requirements; `validation.md` FR-002 | T013, T021, T024, T025, T027, T028, T029, T030, T032, T034, T036, T113 |
| FR-003 | `spec.md` §Requirements; `validation.md` FR-003 | T013, T030, T037, T040, T041, T042, T046, T047, T113 |
| FR-004 | `spec.md` §Requirements; `validation.md` FR-004 | T033, T037, T040, T041, T043, T046, T047, T113 |
| FR-005 | `spec.md` §Requirements; `validation.md` FR-005 | T037, T042, T043, T046, T047, T113 |
| FR-006 | `spec.md` §Requirements; `validation.md` FR-006 | T013, T021, T037, T038, T039, T040, T041, T042, T043, T044, T045, T046, T047, T113 |
| FR-007 | `spec.md` §Requirements; `validation.md` FR-007 | T021, T037, T038, T040, T041, T044, T045, T046, T113 |
| FR-008 | `spec.md` §Requirements; `validation.md` FR-008 | T013, T063, T064, T065, T066, T067, T069, T071, T072, T113 |
| FR-009 | `spec.md` §Requirements; `validation.md` FR-009 | T063, T064, T065, T066, T068, T069, T070, T071, T072, T113 |
| FR-010 | `spec.md` §Requirements; `validation.md` FR-010 | T063, T066, T068, T069, T071, T072, T113 |
| FR-011 | `spec.md` §Requirements; `validation.md` FR-011 | T009, T015, T019, T050, T051, T054, T055, T056, T057, T062, T106, T113 |
| FR-012 | `spec.md` §Requirements; `validation.md` FR-012 | T002, T052, T054, T058, T062, T106, T113 |
| FR-013 | `spec.md` §Requirements; `validation.md` FR-013 | T004, T016, T027, T053, T060, T062, T079, T113 |
| FR-014 | `spec.md` §Requirements; `validation.md` FR-014 | T009, T011, T014, T015, T016, T018, T020, T023, T027, T036, T050, T051, T052, T053, T055, T056, T058, T060, T062, T079, T113 |
| FR-015 | `spec.md` §Requirements; `validation.md` FR-015 | T009, T014, T024, T025, T027, T028, T029, T031, T032, T033, T034, T036, T059, T078, T081, T113 |
| FR-016 | `spec.md` §Requirements; `validation.md` FR-016 | T014, T024, T025, T027, T028, T029, T032, T033, T036, T054, T059, T078, T081, T088, T113 |
| FR-017 | `spec.md` §Requirements; `validation.md` FR-017 | T003, T009, T014, T015, T019, T051, T077, T079, T083, T084, T089, T113 |
| FR-018 | `spec.md` §Requirements; `validation.md` FR-018 | T014, T015, T018, T077, T078, T079, T081, T083, T084, T113 |
| FR-019 | `spec.md` §Requirements; `validation.md` FR-019 | T013, T020, T073, T078, T079, T082, T086, T113 |
| FR-020 | `spec.md` §Requirements; `validation.md` FR-020 | T008, T022, T073, T082, T086, T113 |
| FR-021 | `spec.md` §Requirements; `validation.md` FR-021 | T008, T022, T073, T086, T113 |
| FR-022 | `spec.md` §Requirements; `validation.md` FR-022 | T012, T017, T019, T020, T034, T048, T061, T072, T087, T113 |
| FR-023 | `spec.md` §Requirements; `validation.md` FR-023 | T008, T012, T013, T015, T016, T017, T020, T032, T037, T039, T040, T042, T043, T045, T046, T053, T060, T061, T069, T073, T086, T113 |
| FR-024 | `spec.md` §Requirements; `validation.md` FR-024 | T002, T007, T010, T011, T018, T019, T020, T021, T029, T031, T055, T057, T058, T059, T064, T065, T067, T068, T070, T082, T106, T109, T112, T113 |
| FR-025 | `spec.md` §Requirements; `validation.md` FR-025 | T003, T013, T018, T074, T075, T083, T084, T085, T088, T089, T113 |
| FR-026 | `spec.md` §Requirements; `validation.md` FR-026 | T018, T074, T075, T076, T080, T085, T088, T089, T113 |
| FR-027 | `spec.md` §Requirements; `validation.md` FR-027 | T003, T018, T074, T076, T080, T083, T084, T085, T088, T089, T113 |
| FR-028 | `spec.md` §Requirements; `validation.md` FR-028 | T009, T013, T019, T090, T091, T095, T096, T097, T103, T113 |
| FR-029 | `spec.md` §Requirements; `validation.md` FR-029 | T003, T011, T090, T091, T095, T096, T097, T103, T113 |
| FR-030 | `spec.md` §Requirements; `validation.md` FR-030 | T004, T007, T092, T098, T099, T105, T108, T113 |
| FR-031 | `spec.md` §Requirements; `validation.md` FR-031 | T004, T092, T098, T099, T105, T113 |
| FR-032 | `spec.md` §Requirements; `validation.md` FR-032 | T004, T005, T007, T092, T094, T098, T099, T101, T105, T113 |
| FR-033 | `spec.md` §Requirements; `validation.md` FR-033 | T001, T002, T005, T006, T007, T093, T100, T101, T102, T105, T107, T108, T113 |
| FR-034 | `spec.md` §Requirements; `validation.md` FR-034 | T005, T007, T093, T094, T100, T101, T102, T105, T113 |
| FR-035 | `spec.md` §Requirements; `validation.md` FR-035 | T001, T002, T003, T006, T007, T008, T012, T013, T016, T017, T022, T032, T037, T042, T046, T061, T073, T086, T087, T092, T093, T100, T101, T105, T107, T108, T109, T110, T111, T113 |
| SC-001 | `spec.md` §Success Criteria; `validation.md` SC-001 | T003, T025, T026, T028, T029, T031, T036, T113 |
| SC-002 | `spec.md` §Success Criteria; `validation.md` SC-002 | T035, T113 |
| SC-003 | `spec.md` §Success Criteria; `validation.md` SC-003 | T040, T049, T065, T072, T113 |
| SC-004 | `spec.md` §Success Criteria; `validation.md` SC-004 | T052, T053, T062, T106, T113 |
| SC-005 | `spec.md` §Success Criteria; `validation.md` SC-005 | T078, T082, T089, T106, T113 |
| SC-006 | `spec.md` §Success Criteria; `validation.md` SC-006 | T003, T077, T079, T083, T084, T089, T113 |
| SC-007 | `spec.md` §Success Criteria; `validation.md` SC-007 | T092, T093, T094, T105, T107, T108, T113 |
| SC-008 | `spec.md` §Success Criteria; `validation.md` SC-008 | T033, T041, T066, T071, T080, T088, T104, T113 |
| SC-009 | `spec.md` §Success Criteria; `validation.md` SC-009 | T003, T074, T075, T076, T077, T085, T089, T113 |
| SC-010 | `spec.md` §Success Criteria; `validation.md` SC-010 | T003, T090, T091, T097, T103, T113 |
