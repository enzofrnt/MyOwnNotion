...
- [X] T118 Permettre au gate Playwright local de respecter un parallélisme explicitement configuré, puis documenter la commande complète à cinq profils dans package.json et docs/development.md
