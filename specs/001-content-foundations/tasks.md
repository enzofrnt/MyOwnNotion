...
- [ ] T111 Add the responsive Playwright journey proving that a page can contain both a hierarchy child and an internal page link, and that rename/move/conversion preserve the link target in `tests/e2e/page-links.spec.ts` (US3/AC5–AC6, SC-015)
