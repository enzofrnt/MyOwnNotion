...
- [ ] T306 [US1] [US2] Exécuter le gate exact `bun run checks:local` sur le commit corrigé, pousser, obtenir toute la matrice CI verte, fusionner puis vérifier la CI de `main` avant de mettre à jour l'instance HTTPS locale dans `specs/017-v1-notion-like-workspace/validation.md` per Definition of Done (gate local passé sur `8fe63ac2` ; CI, fusion, `main` et déploiement encore en attente)
