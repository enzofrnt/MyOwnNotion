...
- [X] T285 [US2] [US5] [US7] Corriger la boîte de ligne vide, `caret-color`, la frontière de marque ProseMirror et la restauration de sélection afin que Chromium, Firefox et WebKit affichent le caret et ne recréent jamais un lien supprimé dans `apps/web/src/features/editor/page-editor.tsx`, `apps/web/src/features/editor/editor-links.ts`, `apps/web/src/features/editor/page-editor.css` et `apps/web/src/styles.css` per FR-026, FR-084 et SC-030
