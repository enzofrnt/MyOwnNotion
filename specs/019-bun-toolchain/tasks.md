...
- [ ] T048 Exécuter `bun run checks:local` exactement selon `docs/development.md` et enregistrer le commit candidat et le résultat dans `specs/019-bun-toolchain/validation.md`
